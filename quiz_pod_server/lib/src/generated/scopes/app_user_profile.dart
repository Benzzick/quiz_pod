...
import '../scopes/scopes.dart' as _i2;
...
abstract class AppUserProfile
  ...
  factory AppUserProfile.fromJson(Map<String, dynamic> jsonSerialization) {
    return AppUserProfile(
      ...
      role: _i2.UserScopes.fromJson((jsonSerialization['role'] as String)),
    );
  }
...
class AppUserProfileUpdateTable extends _i1.UpdateTable<AppUserProfileTable> {
  ...
  _i1.ColumnValue<_i2.UserScopes, _i2.UserScopes> role(_i2.UserScopes value) =>
      _i1.ColumnValue(
        table.role,
        value,
      );
...
class AppUserProfileTable extends _i1.Table<int?> {
  ...
  late final _i1.ColumnEnum<_i2.UserScopes> role;
